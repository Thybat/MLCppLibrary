...
{
    public:
        std::vector<double> simple_linear_regression(std::vector<std::vector<double> > dataset);
        double r_2_coeff(std::vector<double> y_predict_values,std::vector<std::vector<double> > x_to_be_predicted,std::vector<std::vector<double> > dataset);
